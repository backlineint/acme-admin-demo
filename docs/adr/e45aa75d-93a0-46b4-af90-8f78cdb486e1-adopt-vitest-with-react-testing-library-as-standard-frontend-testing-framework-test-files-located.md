# Adopt Vitest with React Testing Library as Standard Frontend Testing Framework: Test Files Located
...
1. MUST: Test files MUST be co-located with source files using the naming convention {filename}.test.{tsx|ts}

## Policy Block

- MUST Test files MUST be co-located with source files using the naming convention {filename}.test.{tsx|ts}
