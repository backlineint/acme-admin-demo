...
1. MAY: Test files MAY include integration tests that verify component interactions with external dependencies

## Policy Block

- MAY Test files MAY include integration tests that verify component interactions with external dependencies
