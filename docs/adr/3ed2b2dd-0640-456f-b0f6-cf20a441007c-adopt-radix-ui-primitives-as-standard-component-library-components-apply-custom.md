...
1. SHOULD: Components SHOULD apply custom styling using CSS-in-JS or utility classes while preserving all Radix accessibility attributes and behaviors

## Policy Block

- SHOULD Components SHOULD apply custom styling using CSS-in-JS or utility classes while preserving all Radix accessibility attributes and behaviors
