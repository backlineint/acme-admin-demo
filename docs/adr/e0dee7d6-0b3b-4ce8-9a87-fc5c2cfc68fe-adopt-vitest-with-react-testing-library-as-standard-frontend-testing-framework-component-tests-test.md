# Adopt Vitest with React Testing Library as Standard Frontend Testing Framework: Component Tests Test
...
1. SHOULD: Component tests SHOULD test user-facing behavior rather than implementation details, using accessible queries (getByRole, getByLabelText)

## Policy Block

- SHOULD Component tests SHOULD test user-facing behavior rather than implementation details, using accessible queries (getByRole, getByLabelText)
