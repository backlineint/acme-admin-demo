...
1. MAY: Tests MAY use test utilities and custom render functions to reduce boilerplate and improve maintainability

## Policy Block

- MAY Tests MAY use test utilities and custom render functions to reduce boilerplate and improve maintainability
