...
1. SHOULD: Console.error calls SHOULD be placed immediately after error detection and before any error recovery or user notification logic

## Policy Block

- SHOULD Console.error calls SHOULD be placed immediately after error detection and before any error recovery or user notification logic
