...
1. MUST: Components MUST be placed in the src/components/ui/ directory following the established naming convention (kebab-case matching the Radix primitive name)

## Policy Block

- MUST Components MUST be placed in the src/components/ui/ directory following the established naming convention (kebab-case matching the Radix primitive name)
