# Adopt Vitest for Frontend Component and Unit Testing: Tests Cover Critical
...
1. SHOULD: Tests SHOULD cover critical user paths including authentication flows, CRUD operations, and error handling

## Policy Block

- SHOULD Tests SHOULD cover critical user paths including authentication flows, CRUD operations, and error handling
