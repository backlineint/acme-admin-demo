...
1. MUST: Form components MUST define TypeScript types derived from Zod schemas using z.infer<typeof schema>

## Policy Block

- MUST Form components MUST define TypeScript types derived from Zod schemas using z.infer<typeof schema>
