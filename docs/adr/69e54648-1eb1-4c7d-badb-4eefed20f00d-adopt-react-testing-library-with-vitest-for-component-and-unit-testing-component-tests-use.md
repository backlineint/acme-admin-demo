...
1. MUST: Component tests MUST use React Testing Library for rendering and interaction testing, following user-centric testing patterns

## Policy Block

- MUST Component tests MUST use React Testing Library for rendering and interaction testing, following user-centric testing patterns
