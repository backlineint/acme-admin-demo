...
1. SHOULD: Complex UI components (dialogs, forms, drawers) SHOULD test user interactions, validation logic, and error states

## Policy Block

- SHOULD Complex UI components (dialogs, forms, drawers) SHOULD test user interactions, validation logic, and error states
