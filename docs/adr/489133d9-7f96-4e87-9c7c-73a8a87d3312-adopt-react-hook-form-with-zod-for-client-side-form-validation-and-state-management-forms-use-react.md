...
1. MUST: All forms MUST use React Hook Form for form state management and submission handling

## Policy Block

- MUST All forms MUST use React Hook Form for form state management and submission handling
