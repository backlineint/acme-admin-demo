# Adopt Vitest for Frontend Component and Unit Testing: Typescript Utility Library
...
1. MUST: All TypeScript utility and library files MUST have corresponding .test.ts test files co-located in the same directory

## Policy Block

- MUST All TypeScript utility and library files MUST have corresponding .test.ts test files co-located in the same directory
