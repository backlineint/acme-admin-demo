# Adopt Console-Based Error Logging for Client-Side Error Handling: Error Handling Utilities
...
1. SHOULD: Error handling utilities (such as handle-server-error) SHOULD centralize logging logic to ensure consistency across the application

## Policy Block

- SHOULD Error handling utilities (such as handle-server-error) SHOULD centralize logging logic to ensure consistency across the application
