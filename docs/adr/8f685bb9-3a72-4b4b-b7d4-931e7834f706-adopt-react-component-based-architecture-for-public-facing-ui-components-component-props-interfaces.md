...
1. SHOULD: Component props interfaces SHOULD be explicitly defined and exported for external consumption

## Policy Block

- SHOULD Component props interfaces SHOULD be explicitly defined and exported for external consumption
