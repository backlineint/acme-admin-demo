# Adopt Vitest for Frontend Component and Unit Testing: Test Files Use
...
1. MUST: Test files MUST use Vitest as the test runner and assertion library

## Policy Block

- MUST Test files MUST use Vitest as the test runner and assertion library
