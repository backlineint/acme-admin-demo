...
1. SHOULD: Component interfaces SHOULD include JSDoc comments for non-obvious props to improve IDE documentation

## Policy Block

- SHOULD Component interfaces SHOULD include JSDoc comments for non-obvious props to improve IDE documentation
