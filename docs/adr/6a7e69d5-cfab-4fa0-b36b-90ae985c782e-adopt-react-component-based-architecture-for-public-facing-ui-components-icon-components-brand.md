...
1. MUST: Icon components and brand assets MUST be isolated in the assets/ directory with consistent naming conventions

## Policy Block

- MUST Icon components and brand assets MUST be isolated in the assets/ directory with consistent naming conventions
