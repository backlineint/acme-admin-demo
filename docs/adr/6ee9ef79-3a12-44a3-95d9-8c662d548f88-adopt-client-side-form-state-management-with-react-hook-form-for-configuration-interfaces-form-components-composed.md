# Adopt Client-Side Form State Management with React Hook Form for Configuration Interfaces: Form Components Composed
...
1. SHOULD: Form components SHOULD be composed from reusable field components that encapsulate common patterns (text input, select, checkbox, etc.)

## Policy Block

- SHOULD Form components SHOULD be composed from reusable field components that encapsulate common patterns (text input, select, checkbox, etc.)
