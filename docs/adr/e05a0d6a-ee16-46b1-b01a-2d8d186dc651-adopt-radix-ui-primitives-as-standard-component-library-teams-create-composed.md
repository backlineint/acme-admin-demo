...
1. MAY: Teams MAY create composed components that combine multiple Radix primitives for common use cases (e.g., form fields with labels and error messages)

## Policy Block

- MAY Teams MAY create composed components that combine multiple Radix primitives for common use cases (e.g., form fields with labels and error messages)
