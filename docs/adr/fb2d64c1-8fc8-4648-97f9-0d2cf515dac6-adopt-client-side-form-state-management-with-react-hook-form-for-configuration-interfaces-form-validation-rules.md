# Adopt Client-Side Form State Management with React Hook Form for Configuration Interfaces: Form Validation Rules
...
1. MUST: Form validation rules MUST be defined declaratively using schema validation (e.g., Zod, Yup) and integrated with the form state manager

## Policy Block

- MUST Form validation rules MUST be defined declaratively using schema validation (e.g., Zod, Yup) and integrated with the form state manager
