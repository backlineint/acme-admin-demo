# Adopt Client-Side Form State Management with React Hook Form and Zod Validation: Form Components Handle
...
1. SHOULD: Form components SHOULD handle loading states, error states, and success states consistently using form state

## Policy Block

- SHOULD Form components SHOULD handle loading states, error states, and success states consistently using form state
