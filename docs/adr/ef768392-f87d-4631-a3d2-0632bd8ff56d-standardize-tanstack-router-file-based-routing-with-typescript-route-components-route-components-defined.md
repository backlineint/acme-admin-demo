...
1. MUST: All route components MUST be defined as TypeScript/TSX files using the .tsx extension for type safety and component-based architecture

## Policy Block

- MUST All route components MUST be defined as TypeScript/TSX files using the .tsx extension for type safety and component-based architecture
