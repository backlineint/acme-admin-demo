...
1. MUST: Test utilities and helpers MUST be placed in dedicated test-utils directories with appropriate .ts extensions

## Policy Block

- MUST Test utilities and helpers MUST be placed in dedicated test-utils directories with appropriate .ts extensions
