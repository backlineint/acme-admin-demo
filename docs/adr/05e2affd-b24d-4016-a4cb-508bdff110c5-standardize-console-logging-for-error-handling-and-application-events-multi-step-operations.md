# Standardize Console Logging for Error Handling and Application Events: Multi Step Operations
...
1. SHOULD: Multi-step operations (such as batch deletions) SHOULD log operation start, progress, and completion states

## Policy Block

- SHOULD Multi-step operations (such as batch deletions) SHOULD log operation start, progress, and completion states
