...
1. MAY: Route groups MAY use parenthetical syntax '(groupname)' to organize routes logically without affecting the URL structure

## Policy Block

- MAY Route groups MAY use parenthetical syntax '(groupname)' to organize routes logically without affecting the URL structure
