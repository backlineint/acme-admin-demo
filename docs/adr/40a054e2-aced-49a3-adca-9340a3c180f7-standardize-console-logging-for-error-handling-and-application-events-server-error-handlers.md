# Standardize Console Logging for Error Handling and Application Events: Server Error Handlers
...
1. MUST: Server error handlers MUST log the complete error object including stack traces and error messages

## Policy Block

- MUST Server error handlers MUST log the complete error object including stack traces and error messages
