# Adopt Client-Side Form State Management with React Hook Form and Zod Validation: Form Components Use
...
1. MUST: All form components MUST use React Hook Form for form state management and submission handling

## Policy Block

- MUST All form components MUST use React Hook Form for form state management and submission handling
