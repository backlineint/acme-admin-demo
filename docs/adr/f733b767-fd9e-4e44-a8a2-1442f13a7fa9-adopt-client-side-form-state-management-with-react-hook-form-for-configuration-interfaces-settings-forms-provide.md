# Adopt Client-Side Form State Management with React Hook Form for Configuration Interfaces: Settings Forms Provide
...
1. SHOULD: Settings forms SHOULD provide visual indication of unsaved changes and prompt users before navigation if changes are pending

## Policy Block

- SHOULD Settings forms SHOULD provide visual indication of unsaved changes and prompt users before navigation if changes are pending
