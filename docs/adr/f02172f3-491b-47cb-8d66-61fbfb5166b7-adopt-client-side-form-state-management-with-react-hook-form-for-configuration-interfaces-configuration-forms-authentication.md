# Adopt Client-Side Form State Management with React Hook Form for Configuration Interfaces: Configuration Forms Authentication
...
1. MUST: All configuration forms (authentication, settings, user management) MUST use a declarative form state management library (e.g., React Hook Form, Formik) rather than manual useState management

## Policy Block

- MUST All configuration forms (authentication, settings, user management) MUST use a declarative form state management library (e.g., React Hook Form, Formik) rather than manual useState management
