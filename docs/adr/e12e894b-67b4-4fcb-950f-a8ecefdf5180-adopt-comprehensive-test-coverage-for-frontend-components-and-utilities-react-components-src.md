...
1. MUST: All React components in the src/components and src/features directories MUST have corresponding test files with the .test.tsx extension

## Policy Block

- MUST All React components in the src/components and src/features directories MUST have corresponding test files with the .test.tsx extension
