...
1. SHOULD: Feature components SHOULD compose from reusable primitives rather than implementing custom UI logic

## Policy Block

- SHOULD Feature components SHOULD compose from reusable primitives rather than implementing custom UI logic
