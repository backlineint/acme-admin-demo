...
1. MAY: Forms MAY implement custom validation logic beyond Zod schemas using React Hook Form's validate option when business rules require runtime context

## Policy Block

- MAY Forms MAY implement custom validation logic beyond Zod schemas using React Hook Form's validate option when business rules require runtime context
