...
1. MUST: Cross-cutting concerns (theme, fonts, global configuration) MUST be implemented using React Context API with dedicated provider components

## Policy Block

- MUST Cross-cutting concerns (theme, fonts, global configuration) MUST be implemented using React Context API with dedicated provider components
