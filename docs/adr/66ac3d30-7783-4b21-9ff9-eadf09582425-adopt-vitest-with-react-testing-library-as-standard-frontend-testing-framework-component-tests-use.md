# Adopt Vitest with React Testing Library as Standard Frontend Testing Framework: Component Tests Use
...
1. MUST: Component tests MUST use .test.tsx extension and utility/hook tests MUST use .test.ts extension

## Policy Block

- MUST Component tests MUST use .test.tsx extension and utility/hook tests MUST use .test.ts extension
