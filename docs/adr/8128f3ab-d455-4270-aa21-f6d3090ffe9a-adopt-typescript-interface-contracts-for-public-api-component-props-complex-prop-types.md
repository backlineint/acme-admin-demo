...
1. SHOULD: Complex prop types SHOULD be extracted into separate named interfaces rather than inline type definitions

## Policy Block

- SHOULD Complex prop types SHOULD be extracted into separate named interfaces rather than inline type definitions
