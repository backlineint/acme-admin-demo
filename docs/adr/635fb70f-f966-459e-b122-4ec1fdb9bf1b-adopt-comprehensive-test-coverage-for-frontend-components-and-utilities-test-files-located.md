...
1. MUST: Test files MUST be co-located with their source files in the same directory

## Policy Block

- MUST Test files MUST be co-located with their source files in the same directory
