...
1. MUST: Test files MUST use the exact base name of the source file followed by .test.tsx or .test.ts (e.g., password-input.tsx → password-input.test.tsx)

## Policy Block

- MUST Test files MUST use the exact base name of the source file followed by .test.tsx or .test.ts (e.g., password-input.tsx → password-input.test.tsx)
