# Standardize Console Logging for Error Handling and Application Events: Components Include Additional
...
1. MAY: Components MAY include additional context such as component names, operation types, or user actions in log messages

## Policy Block

- MAY Components MAY include additional context such as component names, operation types, or user actions in log messages
