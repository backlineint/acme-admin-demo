...
1. MUST: Context consumers MUST validate that they are used within the appropriate provider and throw descriptive errors if the context is undefined

## Policy Block

- MUST Context consumers MUST validate that they are used within the appropriate provider and throw descriptive errors if the context is undefined
