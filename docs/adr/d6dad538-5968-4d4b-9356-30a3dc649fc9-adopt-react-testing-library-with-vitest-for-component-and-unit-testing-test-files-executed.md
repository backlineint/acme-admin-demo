...
1. MUST: Test files MUST be executed using Vitest as the test runner and assertion library

## Policy Block

- MUST Test files MUST be executed using Vitest as the test runner and assertion library
