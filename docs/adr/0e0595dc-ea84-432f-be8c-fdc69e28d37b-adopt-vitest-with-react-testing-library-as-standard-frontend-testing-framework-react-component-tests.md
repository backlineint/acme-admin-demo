# Adopt Vitest with React Testing Library as Standard Frontend Testing Framework: React Component Tests
...
1. MUST: All React component tests MUST use Vitest as the test runner and React Testing Library for component rendering and interaction

## Policy Block

- MUST All React component tests MUST use Vitest as the test runner and React Testing Library for component rendering and interaction
