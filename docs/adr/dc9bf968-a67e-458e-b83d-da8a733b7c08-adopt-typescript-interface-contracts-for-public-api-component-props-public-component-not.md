...
1. MUST_NOT: Public component APIs MUST NOT use 'any' type for props without explicit justification and documentation

## Policy Block

- MUST_NOT Public component APIs MUST NOT use 'any' type for props without explicit justification and documentation
