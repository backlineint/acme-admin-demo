# Adopt Vitest for Frontend Component and Unit Testing: Component Tests Verify
...
1. MUST: Component tests MUST verify user interactions, rendering behavior, and state management

## Policy Block

- MUST Component tests MUST verify user interactions, rendering behavior, and state management
