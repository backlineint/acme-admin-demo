...
1. MUST: Component prop interfaces MUST explicitly mark optional properties using the '?' modifier

## Policy Block

- MUST Component prop interfaces MUST explicitly mark optional properties using the '?' modifier
