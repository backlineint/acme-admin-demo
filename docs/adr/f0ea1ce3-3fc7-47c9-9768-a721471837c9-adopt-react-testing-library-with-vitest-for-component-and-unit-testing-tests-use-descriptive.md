...
1. SHOULD: Tests SHOULD use descriptive test names that clearly communicate the behavior being verified

## Policy Block

- SHOULD Tests SHOULD use descriptive test names that clearly communicate the behavior being verified
