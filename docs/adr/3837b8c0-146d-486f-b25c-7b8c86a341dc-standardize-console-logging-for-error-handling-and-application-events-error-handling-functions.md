# Standardize Console Logging for Error Handling and Application Events: Error Handling Functions
...
1. MUST: All error handling functions and utilities MUST log errors to the console using console.error() with contextual information

## Policy Block

- MUST All error handling functions and utilities MUST log errors to the console using console.error() with contextual information
