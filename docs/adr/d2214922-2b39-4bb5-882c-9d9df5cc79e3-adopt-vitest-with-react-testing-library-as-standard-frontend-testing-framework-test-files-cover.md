# Adopt Vitest with React Testing Library as Standard Frontend Testing Framework: Test Files Cover
...
1. SHOULD: Test files SHOULD cover critical user flows including form submissions, dialog interactions, and error handling

## Policy Block

- SHOULD Test files SHOULD cover critical user flows including form submissions, dialog interactions, and error handling
