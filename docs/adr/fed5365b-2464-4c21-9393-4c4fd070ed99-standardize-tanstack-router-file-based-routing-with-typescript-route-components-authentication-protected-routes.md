...
1. MUST: Authentication-protected routes MUST be grouped under the '_authenticated' directory prefix to clearly separate public and private route boundaries

## Policy Block

- MUST Authentication-protected routes MUST be grouped under the '_authenticated' directory prefix to clearly separate public and private route boundaries
