...
1. SHOULD: Provider components SHOULD be placed in a dedicated context directory (e.g., src/context/) for discoverability

## Policy Block

- SHOULD Provider components SHOULD be placed in a dedicated context directory (e.g., src/context/) for discoverability
