...
1. MUST: Authentication flow routes (sign-in, sign-up, forgot-password, otp) MUST be organized under the '(auth)' parenthetical group directory

## Policy Block

- MUST Authentication flow routes (sign-in, sign-up, forgot-password, otp) MUST be organized under the '(auth)' parenthetical group directory
