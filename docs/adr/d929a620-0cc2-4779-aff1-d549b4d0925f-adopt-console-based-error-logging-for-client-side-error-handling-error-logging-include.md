# Adopt Console-Based Error Logging for Client-Side Error Handling: Error Logging Include
...
1. MUST: Error logging MUST include sufficient context (error message, stack trace, component name) to enable effective debugging

## Policy Block

- MUST Error logging MUST include sufficient context (error message, stack trace, component name) to enable effective debugging
