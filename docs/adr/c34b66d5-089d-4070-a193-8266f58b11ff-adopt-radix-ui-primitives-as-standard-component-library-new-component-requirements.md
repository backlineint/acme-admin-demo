...
1. SHOULD: New UI component requirements SHOULD first evaluate if a Radix primitive exists before implementing custom solutions

## Policy Block

- SHOULD New UI component requirements SHOULD first evaluate if a Radix primitive exists before implementing custom solutions
