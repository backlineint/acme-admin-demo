...
1. MUST: All React components MUST have a corresponding unit test file with the .test.tsx extension collocated in the same directory

## Policy Block

- MUST All React components MUST have a corresponding unit test file with the .test.tsx extension collocated in the same directory
