...
1. MUST: Components MUST be organized by feature domain (e.g., features/errors, features/auth, features/dashboard) with clear directory structure

## Policy Block

- MUST Components MUST be organized by feature domain (e.g., features/errors, features/auth, features/dashboard) with clear directory structure
