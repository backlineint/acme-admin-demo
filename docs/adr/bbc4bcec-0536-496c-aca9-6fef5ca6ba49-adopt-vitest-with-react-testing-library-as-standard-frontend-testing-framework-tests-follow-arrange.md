# Adopt Vitest with React Testing Library as Standard Frontend Testing Framework: Tests Follow Arrange
...
1. SHOULD: Tests SHOULD follow the Arrange-Act-Assert pattern for clarity and maintainability

## Policy Block

- SHOULD Tests SHOULD follow the Arrange-Act-Assert pattern for clarity and maintainability
