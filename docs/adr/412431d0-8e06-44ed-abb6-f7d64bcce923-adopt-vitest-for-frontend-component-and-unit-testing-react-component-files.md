# Adopt Vitest for Frontend Component and Unit Testing: React Component Files
...
1. MUST: All React component files MUST have corresponding .test.tsx test files co-located in the same directory

## Policy Block

- MUST All React component files MUST have corresponding .test.tsx test files co-located in the same directory
