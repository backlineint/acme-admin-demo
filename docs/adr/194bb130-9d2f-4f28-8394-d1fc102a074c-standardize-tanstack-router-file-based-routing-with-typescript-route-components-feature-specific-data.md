...
1. SHOULD: Feature-specific data and logic SHOULD be colocated in feature directories (e.g., 'features/apps/data', 'features/users/data') rather than mixed with route components

## Policy Block

- SHOULD Feature-specific data and logic SHOULD be colocated in feature directories (e.g., 'features/apps/data', 'features/users/data') rather than mixed with route components
