...
1. SHOULD: Test files SHOULD be placed in the same directory as their corresponding source files to maintain feature cohesion

## Policy Block

- SHOULD Test files SHOULD be placed in the same directory as their corresponding source files to maintain feature cohesion
