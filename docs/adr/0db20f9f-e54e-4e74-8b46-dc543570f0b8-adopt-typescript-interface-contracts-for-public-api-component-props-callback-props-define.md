...
1. SHOULD: Callback props SHOULD define explicit function signatures including parameter and return types

## Policy Block

- SHOULD Callback props SHOULD define explicit function signatures including parameter and return types
