...
1. MUST: All React components MUST have corresponding test files using the .test.tsx extension co-located with the source file

## Policy Block

- MUST All React components MUST have corresponding test files using the .test.tsx extension co-located with the source file
