# Adopt Client-Side Form State Management with React Hook Form for Configuration Interfaces: Configuration Forms Persist
...
1. SHOULD: Configuration forms SHOULD persist draft state to local storage or session storage to prevent data loss on accidental navigation or page refresh

## Policy Block

- SHOULD Configuration forms SHOULD persist draft state to local storage or session storage to prevent data loss on accidental navigation or page refresh
