...
1. MUST: Reusable UI primitives MUST be placed in the components/ directory and remain domain-agnostic

## Policy Block

- MUST Reusable UI primitives MUST be placed in the components/ directory and remain domain-agnostic
