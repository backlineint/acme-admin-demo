# Adopt React Context Providers for Cross-Cutting External API Integration: Components Not Directly
...
1. MUST_NOT: Components MUST NOT directly call external APIs when the data is available through an established Context Provider

## Policy Block

- MUST_NOT Components MUST NOT directly call external APIs when the data is available through an established Context Provider
