...
1. MUST_NOT: Developers MUST NOT override or remove accessibility attributes (aria-*, role, data-state) provided by Radix primitives

## Policy Block

- MUST_NOT Developers MUST NOT override or remove accessibility attributes (aria-*, role, data-state) provided by Radix primitives
