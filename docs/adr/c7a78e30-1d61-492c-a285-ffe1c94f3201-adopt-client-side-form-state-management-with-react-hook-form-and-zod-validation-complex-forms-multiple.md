# Adopt Client-Side Form State Management with React Hook Form and Zod Validation: Complex Forms Multiple
...
1. SHOULD: Complex forms with multiple steps or sections SHOULD use form context to share state across components

## Policy Block

- SHOULD Complex forms with multiple steps or sections SHOULD use form context to share state across components
