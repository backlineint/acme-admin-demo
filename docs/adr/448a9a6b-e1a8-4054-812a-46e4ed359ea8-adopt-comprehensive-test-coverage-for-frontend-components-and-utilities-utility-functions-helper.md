...
1. MUST: All utility functions and helper modules in src/lib and src/hooks directories MUST have corresponding test files with the .test.ts extension

## Policy Block

- MUST All utility functions and helper modules in src/lib and src/hooks directories MUST have corresponding test files with the .test.ts extension
