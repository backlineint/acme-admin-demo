...
1. SHOULD: Component APIs SHOULD remain close to the Radix primitive API to maintain consistency and reduce learning curve

## Policy Block

- SHOULD Component APIs SHOULD remain close to the Radix primitive API to maintain consistency and reduce learning curve
