...
1. SHOULD: Provider APIs SHOULD follow naming conventions: [Feature]Provider component and use[Feature] hook

## Policy Block

- SHOULD Provider APIs SHOULD follow naming conventions: [Feature]Provider component and use[Feature] hook
