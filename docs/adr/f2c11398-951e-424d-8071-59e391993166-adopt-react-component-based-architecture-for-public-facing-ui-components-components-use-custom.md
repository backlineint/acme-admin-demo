# Adopt React Component-Based Architecture for Public-Facing UI Components: Components Use Custom
...
1. MAY: Components MAY use custom hooks for complex state management or side effects

## Policy Block

- MAY Components MAY use custom hooks for complex state management or side effects
