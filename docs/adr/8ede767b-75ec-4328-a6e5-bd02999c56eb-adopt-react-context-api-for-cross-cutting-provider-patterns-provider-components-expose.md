...
1. MUST: Provider components MUST expose custom hooks (e.g., useTheme, useFont) as the public API for consuming context values

## Policy Block

- MUST Provider components MUST expose custom hooks (e.g., useTheme, useFont) as the public API for consuming context values
