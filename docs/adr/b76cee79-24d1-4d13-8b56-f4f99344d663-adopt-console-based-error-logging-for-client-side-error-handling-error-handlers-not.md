# Adopt Console-Based Error Logging for Client-Side Error Handling: Error Handlers Not
...
1. MUST_NOT: Error handlers MUST NOT silently swallow errors without logging them to the console

## Policy Block

- MUST_NOT Error handlers MUST NOT silently swallow errors without logging them to the console
