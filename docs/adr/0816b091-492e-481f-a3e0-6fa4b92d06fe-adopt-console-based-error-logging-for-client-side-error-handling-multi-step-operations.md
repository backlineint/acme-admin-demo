# Adopt Console-Based Error Logging for Client-Side Error Handling: Multi Step Operations
...
1. SHOULD: Multi-step operations (such as multi-delete dialogs) SHOULD log errors at each failure point to trace operation flow

## Policy Block

- SHOULD Multi-step operations (such as multi-delete dialogs) SHOULD log errors at each failure point to trace operation flow
