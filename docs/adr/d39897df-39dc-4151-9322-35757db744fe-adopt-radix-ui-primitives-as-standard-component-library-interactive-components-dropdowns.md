...
1. MUST: All interactive UI components (dropdowns, dialogs, forms, menus, tabs) MUST be built using Radix UI primitives as the foundational layer

## Policy Block

- MUST All interactive UI components (dropdowns, dialogs, forms, menus, tabs) MUST be built using Radix UI primitives as the foundational layer
