...
1. MUST: All public-facing components MUST define their props interface using TypeScript interface or type declarations

## Policy Block

- MUST All public-facing components MUST define their props interface using TypeScript interface or type declarations
