...
1. MAY: Components MAY extend base interfaces from shared libraries (e.g., React.HTMLAttributes) to inherit standard props

## Policy Block

- MAY Components MAY extend base interfaces from shared libraries (e.g., React.HTMLAttributes) to inherit standard props
