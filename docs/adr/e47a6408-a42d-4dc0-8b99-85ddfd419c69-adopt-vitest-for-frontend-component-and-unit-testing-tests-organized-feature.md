# Adopt Vitest for Frontend Component and Unit Testing: Tests Organized Feature
...
1. SHOULD: Tests SHOULD be organized by feature domain (users, tasks, auth) matching the source code structure

## Policy Block

- SHOULD Tests SHOULD be organized by feature domain (users, tasks, auth) matching the source code structure
