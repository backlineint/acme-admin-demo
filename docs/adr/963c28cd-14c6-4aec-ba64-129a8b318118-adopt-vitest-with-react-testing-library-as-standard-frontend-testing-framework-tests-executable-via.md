# Adopt Vitest with React Testing Library as Standard Frontend Testing Framework: Tests Executable Via
...
1. MUST: All tests MUST be executable via the standard 'npm test' or 'vitest' command in CI/CD pipelines

## Policy Block

- MUST All tests MUST be executable via the standard 'npm test' or 'vitest' command in CI/CD pipelines
