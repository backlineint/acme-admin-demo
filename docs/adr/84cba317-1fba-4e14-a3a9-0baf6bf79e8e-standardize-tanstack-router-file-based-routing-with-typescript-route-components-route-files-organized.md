...
1. MUST: Route files MUST be organized using file-based routing conventions where the file path directly corresponds to the URL path structure

## Policy Block

- MUST Route files MUST be organized using file-based routing conventions where the file path directly corresponds to the URL path structure
