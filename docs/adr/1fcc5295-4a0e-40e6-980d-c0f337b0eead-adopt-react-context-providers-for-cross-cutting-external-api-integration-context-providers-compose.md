# Adopt React Context Providers for Cross-Cutting External API Integration: Context Providers Compose
...
1. MAY: Context Providers MAY compose multiple external API integrations when they represent cohesive functionality

## Policy Block

- MAY Context Providers MAY compose multiple external API integrations when they represent cohesive functionality
