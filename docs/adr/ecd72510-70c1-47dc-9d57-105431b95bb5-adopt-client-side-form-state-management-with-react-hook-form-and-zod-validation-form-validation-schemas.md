# Adopt Client-Side Form State Management with React Hook Form and Zod Validation: Form Validation Schemas
...
1. SHOULD: Form validation schemas SHOULD be colocated with form components or defined in a shared schema directory

## Policy Block

- SHOULD Form validation schemas SHOULD be colocated with form components or defined in a shared schema directory
