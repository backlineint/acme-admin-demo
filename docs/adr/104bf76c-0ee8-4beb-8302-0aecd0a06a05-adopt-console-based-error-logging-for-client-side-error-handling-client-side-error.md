# Adopt Console-Based Error Logging for Client-Side Error Handling: Client Side Error
...
1. MUST: All client-side error handlers MUST log errors to the browser console using console.error() for critical errors

## Policy Block

- MUST All client-side error handlers MUST log errors to the browser console using console.error() for critical errors
