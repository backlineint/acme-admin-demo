# Adopt React Context Providers for Cross-Cutting External API Integration: Context Providers External
...
1. MUST: Context Providers for external APIs MUST be placed at appropriate levels in the component tree to scope their availability (application root for global APIs, feature root for feature-specific APIs)

## Policy Block

- MUST Context Providers for external APIs MUST be placed at appropriate levels in the component tree to scope their availability (application root for global APIs, feature root for feature-specific APIs)
