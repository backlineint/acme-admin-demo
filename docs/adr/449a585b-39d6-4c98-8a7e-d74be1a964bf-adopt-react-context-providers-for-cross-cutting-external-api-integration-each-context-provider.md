# Adopt React Context Providers for Cross-Cutting External API Integration: Each Context Provider
...
1. MUST: Each Context Provider MUST expose a custom hook (e.g., useTheme, useFontProvider) for consuming components to access the external API data and state

## Policy Block

- MUST Each Context Provider MUST expose a custom hook (e.g., useTheme, useFontProvider) for consuming components to access the external API data and state
