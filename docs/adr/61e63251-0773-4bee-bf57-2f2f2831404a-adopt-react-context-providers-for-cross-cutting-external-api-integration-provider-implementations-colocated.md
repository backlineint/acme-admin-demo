# Adopt React Context Providers for Cross-Cutting External API Integration: Provider Implementations Colocated
...
1. SHOULD: Provider implementations SHOULD be colocated in a dedicated context directory (e.g., src/context/) for discoverability

## Policy Block

- SHOULD Provider implementations SHOULD be colocated in a dedicated context directory (e.g., src/context/) for discoverability
