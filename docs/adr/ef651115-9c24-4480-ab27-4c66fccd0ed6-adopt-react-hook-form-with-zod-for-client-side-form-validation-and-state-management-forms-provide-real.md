...
1. SHOULD: Forms SHOULD provide real-time validation feedback using React Hook Form's mode configuration (onChange, onBlur, or onSubmit)

## Policy Block

- SHOULD Forms SHOULD provide real-time validation feedback using React Hook Form's mode configuration (onChange, onBlur, or onSubmit)
