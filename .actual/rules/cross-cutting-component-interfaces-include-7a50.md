# Adopt TypeScript Interface Contracts for Public API Component Props: Component Interfaces Include
...
- **R-INTERFACE-001** SHOULD: Component interfaces SHOULD include JSDoc comments for non-obvious props to improve IDE documentation.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. TypeScript compilation and interface presence checks are mandatory before accepting component implementations.
</enforcement>