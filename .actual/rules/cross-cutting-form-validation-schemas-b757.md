...
- **R-FORM-001** MUST: Form validation schemas MUST be defined using Zod and integrated with React Hook Form via @hookform/resolvers/zod
...
<enforcement>
Clause Code MUST NOT skip or defer verification of form validation schema compliance. All new forms and form modifications must satisfy the acceptance criteria before merge.
</enforcement>